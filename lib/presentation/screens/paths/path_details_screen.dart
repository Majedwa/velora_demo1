...
class _PathDetailsScreenState extends State<PathDetailsScreen> {
  ...
  Future<void> _loadPathDetails() async {
    ...
    final savedPathsProvider = Provider.of<SavedPathsProvider>(context, listen: false);
  ...
  void _toggleSaved() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(_isSaved ? 'تم حفظ المسار' : 'تم إزالة المسار من المحفوظات'),
          ...
          SliverAppBar(
            ...
            actions: [
              Container(
                ...
                child: IconButton(
                  icon: Icon(
                    _isSaved ? PhosphorIcons.bookmark_simple_fill : PhosphorIcons.bookmark_simple,
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: _getDifficultyColor(_path.difficulty).withOpacity(0.9),
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 8,
          runSpacing: 8,
          children: _path.activities.map((activity) {
            return Container(
                    ...
                    children: List.generate(5, (index) {
                      return Icon(
                        index < _path.rating.floor() 
                            ...
                            : (index == _path.rating.floor() && _path.rating % 1 > 0) 
